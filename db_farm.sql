...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2019 at 01:13 PM
...
INSERT INTO `tb_courier` (`id_courier`, `username`, `courier_name`) VALUES
('COU-1312', 'kokoko', 'Wahtyu Hidayat');
...
('ORD-1001', 'prasetya2423', 14, 'AGN-1571747859135', 'PRO-133', 10, 150000, '2019-09-30', 1),
('ORD-1002', 'prasetya2423', 14, 'AGN-1571747859135', 'PRO-133', 100, 1500000, '2019-09-30', 1),
('ORD-123313', 'google123', 16, 'AGN-1569672565454', 'PRO-133', 100, 1500000, '2019-01-01', 1);
...
INSERT INTO `tb_product` (`id_product`, `product_name`, `description`, `image`, `quality`, `stock`, `price`) VALUES
('PRO-133', 'Telur Ayam Negeri', 'Telur adalah pangan padat gizi, karenanya telur merupakan sumber protein hewani, sumber asam lemak tidak jenuh, sumber vitamin dan mineral. Telur sangat baik untuk anak-anak dan orang dewasa, penderita diabetes (kencing manis) dan wanita yang ingin sehat ', 'telor.png', 'Retak Ringan', 99890, 15000);
...
('TRN-1573941743', 'ORD-1001', 'COU-1312', 15000000, '2019-11-16', 1),
('TRN-1573941901', 'ORD-123313', 'COU-1312', 1500000, '2019-11-16', 1),
('TRN-1573941993', 'ORD-123313', 'COU-1312', 1500000, '2019-11-16', 1),
('TRN-1573992631', 'ORD-1001', 'COU-1312', 150000, '2019-11-17', 1);
...
('admin', 'admin', 'admin', 'admin@gmail.co.id', '21232f297a57a5a743894a0e4a801fc3', '0132412432', 'admin'),
('google123', 'prasetya', 'hadi s', 'prasetya22@gmail.com', 'b8f8312b939f00abb38eeafd4fd107f3', '', 'agent'),
('kokoko', 'Wahtyu', 'Hidayat', 'gentaprima600@gmail.com', 'd5cbfe9ff07fef1ecc93861ce5dd4f3b', '41413', 'courier'),
...
(97, 'gentaprima600@gmail.com', 'HQsruQp9RdGUVur+lRNaNwlDVF5a0QXFkQMlvyqswCM='),
(98, 'gentaprima600@gmail.com', 'u1B0l6K+MDuFx/3UGJiYXtguXh+48lsJ716liIA5vso='),
(99, 'gentaprima600@gmail.com', 'ZATWUFIAsvrqlUTnYHxgN2jF+jZtMjKagS4Pey1ciWs='),
(100, 'gentaprima600@gmail.com', 'gmOklYs6c1sYbLRVeoJTO4fWx2ZY+zsvS6/hJhV/6eo=');
...
--
ALTER TABLE `user_token`
  MODIFY `id_user_token` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
