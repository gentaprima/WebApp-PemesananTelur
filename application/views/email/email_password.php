...
<p style="text-align: center;">Klik link dibawah ini untuk  Reset Password</p>
    ...
    <tbody class="mcnTextBlockOuter">
        <tr>
            <td valign="top" class="mcnTextBlockInner">
                <center>
					<p style="border-top:2px solid #4baea0;text-align:center;width:150px;"></p>
					<a href="<?= $link; ?>" style="font-family:verdana;font-weight:bold;color:#4baea0">Klik Untuk Reset !</a>
					<p style="border-top:2px solid #4baea0;text-align:center; width:150px;"></p
				></center>
            </td>
        </tr>
