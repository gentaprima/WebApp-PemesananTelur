                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h3 style="text-align: center;">Halo! <?= $name; ?></h3>

<p style="text-align: center;">Masukan Kode OTP anda untuk melakukan <?= $header; ?></p>
    ...
    <tbody class="mcnTextBlockOuter">
        <tr>
            <td valign="top" class="mcnTextBlockInner">
                <center><p style="border-top:2px solid #4baea0;text-align:center;width:150px;"></p>

<p style="font-family:verdana;font-weight:bold;color:#4baea0">OTP : <?= $token; ?></p>
<p style="border-top:2px solid #4baea0;text-align:center; width:150px;"></p></center>
            </td>
        </tr>
    </tbody>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <em>Copyright © PT MOELADI PETERNAKAN</em><br>
<br>
<strong>Our mailing address is:</strong><br>
ptmoeladi@gmail.com<br>
&nbsp;
                        </td>
                    </tr>
                </tbody></table>
