...
<body class="fp-page">
    <div class="fp-box">
        ...
        <div class="card">
            <div class="body">
                <form id="forgot_password" action="<?= base_url() ?>users/changePassword/" method="POST">
                    <div class="msg">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control" name="confirmPassword" placeholder="New Password (Confirm)" required autofocus>
                        </div>
                    </div>
